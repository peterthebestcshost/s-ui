...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/peterthebestcshost/s-ui/master/install.sh)
```
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/peterthebestcshost/s-ui/master/install.sh) 0.0.1
```
